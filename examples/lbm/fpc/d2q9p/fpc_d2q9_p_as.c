...
int main(void) {
  ...
  printf("2D Flow Past Cylinder simulation with D2Q9 lattice:\n"
...
void lbm_kernel(double in_c, double in_n, double in_s, double in_e, double in_w,
  ...
  /*   in_n = in_s; */
  /*   in_ne = in_sw; */
  /*   in_nw = (1.0 / 2.0) * (rho_in - (in_c + in_e + in_w + in_n + in_s + in_ne
   * + in_sw)); */
  /*   in_se = (1.0 / 2.0) * (rho_in - (in_c + in_e + in_w + in_n + in_s + in_ne
   * + in_sw)); */
  /* } */
  /*  */
  /* if ((x == 2) && (y == nY + 2)) { */
  ...
  /*   in_se = in_nw; */
  /*  */
  /*   in_sw = (1.0 / 2.0) * (rho_in - (in_c + in_e + in_w + in_n + in_s + in_se
   * + in_nw)); */
  /*   in_ne = (1.0 / 2.0) * (rho_in - (in_c + in_e + in_w + in_n + in_s + in_se
   * + in_nw)); */
  /* } */
  /*  */
  /*  */
  ...
  /*   in_nw = in_se; */
  /*  */
  /*   in_ne = (1.0 / 2.0) * (rho_out - (in_c + in_e + in_w + in_n + in_s +
   * in_nw + in_se)); */
  /*   in_sw = (1.0 / 2.0) * (rho_out - (in_c + in_e + in_w + in_n + in_s +
   * in_nw + in_se)); */
  /* } */
  /*  */
  /* if ((x == nX + 1) && (y == 3)) { */
  ...
  /*   in_sw = in_ne; */
  /*  */
  /*   in_nw = (1.0 / 2.0) * (rho_out - (in_c + in_e + in_w + in_n + in_s +
   * in_ne + in_sw)); */
  /*   in_se = (1.0 / 2.0) * (rho_out - (in_c + in_e + in_w + in_n + in_s +
   * in_ne + in_sw)); */
  /* } */
