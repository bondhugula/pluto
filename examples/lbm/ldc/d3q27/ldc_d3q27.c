...
int main(void) {
  ...
  printf("3D Lid Driven Cavity simulation with D3Q27 lattice:\n"
      ...
      for (y = 1; y < _nY; y++) {
        for (x = 1; x < _nX; x++) {
          lbm_kernel(
              ...
              &grid[(t + 1) % 2][z][y][x][C], &grid[(t + 1) % 2][z][y][x][E],
              &grid[(t + 1) % 2][z][y][x][W], &grid[(t + 1) % 2][z][y][x][N],
              &grid[(t + 1) % 2][z][y][x][S], &grid[(t + 1) % 2][z][y][x][T],
              &grid[(t + 1) % 2][z][y][x][B], &grid[(t + 1) % 2][z][y][x][NE],
              &grid[(t + 1) % 2][z][y][x][NW], &grid[(t + 1) % 2][z][y][x][SE],
              &grid[(t + 1) % 2][z][y][x][SW], &grid[(t + 1) % 2][z][y][x][TE],
              &grid[(t + 1) % 2][z][y][x][TW], &grid[(t + 1) % 2][z][y][x][BE],
              &grid[(t + 1) % 2][z][y][x][BW], &grid[(t + 1) % 2][z][y][x][TN],
              &grid[(t + 1) % 2][z][y][x][TS], &grid[(t + 1) % 2][z][y][x][BN],
              &grid[(t + 1) % 2][z][y][x][BS], &grid[(t + 1) % 2][z][y][x][TNE],
...
void lbm_kernel(
  ...
  *out_tn =
      (1.0 - omega) * in_tn +
      (omega * (w3 * rho *
                (1.0 + 3.0 * (+uY + uZ) + 4.5 * (+uY + uZ) * (+uY + uZ) - u2)));
  *out_ts =
      (1.0 - omega) * in_ts +
      (omega * (w3 * rho *
                (1.0 + 3.0 * (-uY + uZ) + 4.5 * (-uY + uZ) * (-uY + uZ) - u2)));
  *out_te =
      (1.0 - omega) * in_te +
      (omega * (w3 * rho *
                (1.0 + 3.0 * (+uX + uZ) + 4.5 * (+uX + uZ) * (+uX + uZ) - u2)));
  *out_tw =
      (1.0 - omega) * in_tw +
      (omega * (w3 * rho *
                (1.0 + 3.0 * (-uX + uZ) + 4.5 * (-uX + uZ) * (-uX + uZ) - u2)));
  ...
  *out_tne = (1.0 - omega) * in_tne +
             (omega * (w4 * rho *
                       (1.0 + 3.0 * (+uX + uY + uZ) +
                        4.5 * (+uX + uY + uZ) * (+uX + uY + uZ) - u2)));
  *out_tnw = (1.0 - omega) * in_tnw +
             (omega * (w4 * rho *
                       (1.0 + 3.0 * (-uX + uY + uZ) +
                        4.5 * (-uX + uY + uZ) * (-uX + uY + uZ) - u2)));
  *out_tse = (1.0 - omega) * in_tse +
             (omega * (w4 * rho *
                       (1.0 + 3.0 * (+uX - uY + uZ) +
                        4.5 * (+uX - uY + uZ) * (+uX - uY + uZ) - u2)));
  *out_tsw = (1.0 - omega) * in_tsw +
             (omega * (w4 * rho *
                       (1.0 + 3.0 * (-uX - uY + uZ) +
                        4.5 * (-uX - uY + uZ) * (-uX - uY + uZ) - u2)));
  *out_bne = (1.0 - omega) * in_bne +
             (omega * (w4 * rho *
                       (1.0 + 3.0 * (+uX + uY - uZ) +
                        4.5 * (+uX + uY - uZ) * (+uX + uY - uZ) - u2)));
  *out_bnw = (1.0 - omega) * in_bnw +
             (omega * (w4 * rho *
                       (1.0 + 3.0 * (-uX + uY - uZ) +
                        4.5 * (-uX + uY - uZ) * (-uX + uY - uZ) - u2)));
  *out_bse = (1.0 - omega) * in_bse +
             (omega * (w4 * rho *
                       (1.0 + 3.0 * (+uX - uY - uZ) +
                        4.5 * (+uX - uY - uZ) * (+uX - uY - uZ) - u2)));
  *out_bsw = (1.0 - omega) * in_bsw +
             (omega * (w4 * rho *
                       (1.0 + 3.0 * (-uX - uY - uZ) +
                        4.5 * (-uX - uY - uZ) * (-uX - uY - uZ) - u2)));
}
