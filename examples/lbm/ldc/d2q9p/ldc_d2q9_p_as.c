    ...
    for (y = 0; y < _nY; y++) {
      for (x = 0; x < _nX; x++) {
        lbm_kernel(grid[t % 2][y][x][C],
                   grid[t % 2][y==0?_nY-1:y - 1][x + 0][N],
                   grid[t % 2][y==_nY-1?0:y + 1][x + 0][S],
                   grid[t % 2][y + 0][x==0?_nX-1:x - 1][E],
                   grid[t % 2][y + 0][x==_nX-1?0:x + 1][W],
                   grid[t % 2][y==0?_nY-1:y - 1][x==0?_nX-1:x - 1][NE],
                   grid[t % 2][y==0?_nY-1:y-1][x==_nX-1?0:x+1][NW],
                   grid[t % 2][y==_nY-1?0:y+1][x==0?_nX-1:x-1][SE],
                   grid[t % 2][y==_nY-1?0:y+1][x==_nX-1?0:x+1][SW],
                   &grid[(t + 1) % 2][y][x][C],
                   &grid[(t + 1) % 2][y][x][N],
                   &grid[(t + 1) % 2][y][x][S],
                   &grid[(t + 1) % 2][y][x][E],
