...
#define __DECLARATION_OF_s DATA_TYPE POLYBENCH_1D(s,NY,ny)
#define __DECLARATION_OF_q DATA_TYPE POLYBENCH_1D(q,NX,nx)
#define __DECLARATION_OF_p DATA_TYPE POLYBENCH_1D(p,NY,ny)
#define __DECLARATION_OF_r DATA_TYPE POLYBENCH_1D(r,NX,nx)
