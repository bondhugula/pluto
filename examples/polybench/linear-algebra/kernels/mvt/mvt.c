...
#define __DECLARATION_OF_x1 DATA_TYPE POLYBENCH_1D(x1,N,n)
#define __DECLARATION_OF_x2 DATA_TYPE POLYBENCH_1D(x2,N,n)
#define __DECLARATION_OF_y_1 DATA_TYPE POLYBENCH_1D(y_1,N,n)
#define __DECLARATION_OF_y_2 DATA_TYPE POLYBENCH_1D(y_2,N,n)
