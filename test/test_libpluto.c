...
void test1() {
  ...
  domains = isl_union_set_read_from_str(
      ctx, "[n] -> {S_1[i0, i1] : i0 >= 0 and i0 <= 99 and i1 >= 0 and i1 <= "
           "99; S_0[i0] : i0 >= 0 and i0 <= 99; S_2[i0] : i0 >= 0 and i0 <= 99 "
           "}");
  deps = isl_union_map_read_from_str(
      ctx, "[n] -> {S_1[i0, 99] -> S_0[1 + i0] : i0 >= 0 and i0 <= 98; S_1[i0, "
...
int test2() {
  ...
  isl_union_set *domains = isl_union_set_read_from_str(
      ctx, "[p_0, p_1, p_2, p_3, p_4, p_5, p_7] -> { S_1[i0, i1] : i0 >= 0 and "
           "i0 <= p_0 and i1 >= 0 and i1 <= p_3 and p_2 >= 0; S_0[i0] : i0 >= "
           "0 and i0 <= p_0}");
  isl_union_map *deps = isl_union_map_read_from_str(
      ctx, "[p_0, p_1, p_2, p_3, p_4, p_5, p_7] -> { S_0[i0] -> S_1[o0, o1] : "
