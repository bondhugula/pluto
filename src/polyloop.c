...
Ploop **pluto_get_dom_parallel_loops(const PlutoProg *prog, unsigned *ndploops)
{
...
Band **pluto_get_dominator_bands(Band **bands, unsigned nbands, unsigned *ndom_bands)
{
    Band **dom_bands;
