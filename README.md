...
- `make check` to test for correctness, `make perf` to compare performance.
...
To launch a complete verification that compares output of tiled, par with orig for all examples, in `examples/`, run `make check`.
