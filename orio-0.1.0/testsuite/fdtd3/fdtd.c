...
int main(int argc, char *argv[]) {
    ...
    free((void *) update);
    free((void *) update_indexA);
    free((void *) externalA);
    free((void *) extern_indexA);
    free((void *) bindxA);
    free((void *) valA);
    free((void *) data_orgA);
...
void create_curl_matrix_row_edge(int row, int location, double val[],
    ...
    case 0: {
        /* dBz / dy */
        bindx[k] = compZ + pos_to_row(x, y+upper, z);
        val[k++] = +1. / dy;
        bindx[k] = compZ + pos_to_row(x, y+lower, z);
        val[k++] = -1. / dy;

        /* - dBy / dz */
        bindx[k] = compY + pos_to_row(x, y, z+upper);
        val[k++] = -1. / dz;
        bindx[k] = compY + pos_to_row(x, y, z+lower);
        val[k++] = +1. / dz;
        break;
    }
    ...
    case 1: {
        /* dBx / dz  */
        bindx[k] = compX + pos_to_row(x, y, z+upper);
        val[k++] = +1. / dz;
        bindx[k] = compX + pos_to_row(x, y, z+lower);
        val[k++] = -1. / dz;
        /* -dBz / dx  */
        bindx[k] = compZ + pos_to_row(x+upper, y, z);
        val[k++] = -1. / dx;
        bindx[k] = compZ + pos_to_row(x+lower, y, z);
        val[k++] = +1. / dx;
        break;
    }
    ...
    case 2: {
        /* dBy/dx  */
        bindx[k] = compY + pos_to_row(x+upper, y, z);
        val[k++] = +1. / dx;
        bindx[k] = compY + pos_to_row(x+lower, y, z);
        val[k++] = -1. / dx;

        /* -dBx/dy  */
        bindx[k] = compX + pos_to_row(x, y+upper, z);
        val[k++] = -1. / dy;
        bindx[k] = compX + pos_to_row(x, y+lower, z);
        val[k++] = +1. / dy;
        break;
    }
    }
    ...
    bindx[location+1] = k;
    val[location]     = 0.; /* matrix diagonal */
}
