...
set title "3-D Gauss Seidel (Parallel) with T=1024, N=1024" #font "Helvetica,20"
...
#set output 'seidel-par.eps'
set output 'seidel-par.png'

set style line 1 lt 9 lw 3 pt 3 ps 0.5
set style line 2 lt 7 lw 2 pt 3 ps 0.5

plot 'seidel-par.dat' using 1:2 title 'ICC -parallel -fast' ,  \
