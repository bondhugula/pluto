...
set title "GEMVER (Parallel) with N=10000" #font "Helvetica,20"
...
set output 'gemver-par.eps'
#set output 'gemver-par.png'

set style line 1 lt 9 lw 3 pt 3 ps 0.5
set style line 2 lt 7 lw 2 pt 3 ps 0.5

plot 'gemver-par.dat' using 1:2 title 'ICC -parallel -fast' ,  \
