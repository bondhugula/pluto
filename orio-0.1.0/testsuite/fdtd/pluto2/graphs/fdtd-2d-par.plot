...
set title "FDTD-2D (Parallel) with T=500, N=2000" #font "Helvetica,20"
...
#set output 'fdtd-2d-par.eps'
set output 'fdtd-2d-par.png'

set style line 1 lt 9 lw 3 pt 3 ps 0.5
set style line 2 lt 7 lw 2 pt 3 ps 0.5

plot 'fdtd-2d-par.dat' using 1:2 title 'ICC -parallel -fast' ,  \
